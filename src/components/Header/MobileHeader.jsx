...
export default function Header() {
    ...
    let headerStyle = 'flex justify-between items-center w-full px-4 fixed top-0 z-10 py-4' + textColor;
    ...
    if (isSearchShowed) {
        return (
            <header className={headerStyle}>
                ...
                <section className="absolute top-[4.55em] left-0 bg-white shadow-xl w-full h-fit z-[101]" id="search-results"></section>
            </header>
        )
    }
            ...
            <nav className="w-[30em] flex justify-end">
                <ul className="flex gap-3">
                    ...
                    <li className="relative">
                        <Link to={user !== null ? '/account/dashboard' : '/login'}>
